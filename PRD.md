...
A professional interactive website showcasing the demo's solution for German police forces, communicating the value of multi-layered ontology-based knowledge management systems for modern law enforcement.
...
This is an interactive educational landing page that guides German police through RELIEF technology with stateful interactions, animated visualizations, and a progressive disclosure user journey. Features include clickable layers, tabbed scenarios, scroll-based animations, and guided navigation.

## Essential Features

### Hero Section with Graph & GraphRAG Demo Branding
- **Functionality**: Displays Graph & GraphRAG Demo logo, compelling headline about digital knowledge assistants for police, and primary CTA
...
- **Success criteria**: User understands this is a Graph & GraphRAG Demo solution for police within 3 seconds
...
- **Success criteria**: User can envision RELIEF in their daily work

### Call-to-Action Section
- **Functionality**: Prominent link to official the Graph Graph & GraphRAG Demo RELIEF GraphRAG demo website with supporting context
- **Purpose**: Convert interest into action by directing to comprehensive information
- **Trigger**: User clicks CTA button
- **Progression**: CTA appears → User clicks → Opens official RELIEF page in new tab
...
A sophisticated palette that balances the demo's corporate identity with associations of trust, security, and German public service.

- **Primary Color (Deep Navy)**: oklch(0.25 0.05 250) - Conveys authority, security, and institutional trust; the demo's signature dark blue
...
- **Components**:
  ...
  - Button (Shadcn): Primary CTA to RELIEF website, styled with accent color and subtle hover elevation
