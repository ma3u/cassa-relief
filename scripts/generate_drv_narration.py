#!/usr/bin/env python3
"""Generate ElevenLabs narration audio for the DRV demo — Fall Müller.
...
NARRATION_TEXT = """Willkommen bei diesem Demo — einem digitalen Wissensassistenten für die Deutsche Rentenversicherung.
