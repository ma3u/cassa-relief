#!/usr/bin/env python3
"""Generate ElevenLabs narration audio for the police knowledge graph demo."""
import json, urllib.request, os, sys

API_KEY = os.environ.get("ELEVENLABS_API_KEY", "")
VOICE_ID = "FTNCalFNG5bRnkkaP5Ug"  # Otto - Native German male, warm narrator

NARRATION_TEXT = """Hallo und willkommen — zu dieser Demo eines intelligenten Wissensgraphen.
...
Genau hier setzt der Wissensgraph an — mit einer Multi-Layered Ontologie-Architektur in vier Schichten.
...
88 Knoten, 113 Beziehungen, 18 Knotentypen, 10 Länder, 12 Services, 7 Schlüsselpersonen, 12 Ereignisse — das ist der Hydra Graph. Ein System, das genauso vernetzt denkt wie die organisierte Kriminalität selbst agiert. Aber auf der richtigen Seite des Gesetzes."""
