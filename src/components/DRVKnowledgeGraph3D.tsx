...
function buildCaseData(): GraphData {
  const nodes: GraphNode[] = [
    ...
    { id: 'api_relief', label: 'RELIEF Chat API', type: 'chatapi', description: 'Demo-API: OpenAI-kompatibel + GraphRAG-Erweiterungen', details: { 'Endpunkte': '/api/v1/chat, /api/v1/search', 'Erweiterung': 'citations[], session_id, context{}', 'Kompatibilität': 'OpenAI messages[]-Format', 'Swagger': '/api/docs (lokal)' } },
