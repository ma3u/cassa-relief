...
function buildCaseData(): GraphData {
  const nodes: GraphNode[] = [
    ...
    { id: 'api_relief', label: 'GraphRAG Chat API', type: 'chatapi', description: 'Demo-API: OpenAI-kompatibel mit GraphRAG-Erweiterungen', details: { 'Endpunkte': '/api/v1/chat, /api/v1/search', 'Erweiterung': 'citations[], session_id, context{}', 'Kompatibilität': 'OpenAI messages[]-Format', 'Swagger': '/api/docs (lokal)' } },
  ...
  const links: GraphLink[] = [
    ...
    { source: 'api_relief', target: 'api_openai', type: 'SR_COMPATIBLE', description: 'kompatibel mit' },
    { source: 'api_relief', target: 'api_openapi', type: 'SR_COMPATIBLE', description: 'dokumentiert via' },
    { source: 'api_relief', target: 'api_langchain', type: 'SR_COMPATIBLE', description: 'integrierbar mit' },
